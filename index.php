                    ...
                    <div class="d-inline justify-content-end">
                        <ul class="navbar-nav navbar-expand-md">
                            ...
                            <li class="nav-item dropdown d-md-block d-lg-none">
                                <a class="nav-link" href="javascript:void(0)" id="settingDropdownMenuLink"
                        ...
                        <div class="row mx-0">
                            <div class=" col-12 col-sm-12 col-md-12 col-lg-12 pl-lg-0">
                                <div id="latestReleaseMoviesSlider" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            ...
                                            <img class="d-block w-100"
                                                src="assets/movie-posters/INTERSTELLAR.jpg"
                                                alt="First slide">
                                            <div class="carousel-caption d-none d-md-block">
                                                <!-- <h5>Back in Cinema!</h5> -->
                                                <!--                            <p>...</p>-->
                                            </div>
                                        </div>
                                        <div class="carousel-item ">
                                            <img class="d-block w-100"
                                                src="assets/movie-posters/OPPENHEIMER.jpg" alt="Third slide">
                                            <div class="carousel-caption d-none d-md-block">
                                                <!-- <h5>The BeeKeeper</h5> -->
                                                <!--                            <p>...</p>-->
                                            </div>
                                        ...
                                        <div class="carousel-item">
                                            <img class="d-block w-100"
                                                src="assets/movie-posters/BATMAN.jpg" alt="Second slide">
                                            <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <a class="carousel-control-prev" href="#latestReleaseMoviesSlider" role="button"
                                        data-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="sr-only">Previous</span>
                                    </a>
                                    <span class="control-divider">|</span>
                                    <a class="carousel-control-next" href="#latestReleaseMoviesSlider" role="button"
                                        data-slide="next">
                                        ...
                                        <div class="movie card">
                                            <a href="view-movie.php?movie_id=<?= $comingMovie->id ?>" class="h-100">
                                                <figure class="movie-poster">
                                                    <img src="./assets/uploads/<?= $comingMovie->image ?>" class="img-fluid"
                                                        alt="movie poster here">
                                                </figure>
                                                <div class="movie-info">
                                                    <h5 class="text-bold mb-1"> <b><?= $comingMovie->name ?></b> </h5>
                                                    <span class="rattings"><i
                                                            class="fa fa-star text-warning mx-1"></i><?= $comingMovie->imdb_ratings ?></span>
                                                </div>
                                            </a>
                                        </div>
                                ...
                                <div class="row mx-0">
                                    <div class="col-6">
                                        <h3 class="text-capitalize text-white font-weight-bold">In Cinemas Now
                                            <sup class="badge badge-sm bg-primary">Book Tickets Now</sup>
                                        </h3>
                                    </div>
                                    <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                    ...
                                    while ($cinemaMovie = $inTheaterMoviesResult->fetch_object()) {
                                        ...
                                        <div class="movie card">
                                            ...
                                            <a href="view-movie.php?movie_id=<?= $cinemaMovie->id ?>" class="h-100">
                                                <figure class="movie-poster">
                                                    <img src="./assets/uploads/<?= $cinemaMovie->image ?>" class="img-fluid"
                                                        alt="movie poster here">
                                                </figure>
                                                <div class="movie-info">
                                                    <h5 class="text-bold mb-1"> <b><?= $cinemaMovie->name ?></b> </h5>
                                                    <span class="rattings"><i
                                                            class="fa fa-star text-warning mx-1"></i><?= $cinemaMovie->imdb_ratings ?></span>
                                                </div>
                                            </a>
                                        </div>
